...
class About(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['description'] = """
            Вы хотите продать или купить что-либо быстро и выгодно? К Вашим услугам доска бесплатных объявлений!
            
            На нашем портале Вы найдёте всё, начиная от мелких бытовых приборов и заканчивая недвижимостью и автомобилями. А если Вы продаёте товар, услугу, сдаёте или снимаете жильё, мы поможем решить Вашу задачу быстро и эффективно. Для этого просто добавьте объявление! Это бесплатно!"""
        return context
